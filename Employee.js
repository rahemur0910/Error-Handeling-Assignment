...
class Employee
{
    ...
    getSalary() {
        return `the employee's salary is: ${this.salary}`;
    }
}

const myEmployee = new Employee("Sk Rahemur Rahaman","Front-End Developer",10000);

const salary = myEmployee.getSalary();
console.log(salary);